...
export function AssessmentSection() {
  ...
  const challenges = ["Eliminate soul-crushing lead-times that kill momentum and opportunities", "Access world-class talent anywhere, anytime—scale like a tech giant", "Ditch overpriced consultants who talk more than they deliver", "Rescue your burned-out teams from impossible project loads"];
  return <section id="approach" className="py-20 bg-gradient-to-b from-slate-900 to-slate-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Our Approach: 
Deploy. Deliver. Dominate.</h2>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {focusAreas.map((area, index) => <div key={index} className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:border-blue-500/50 hover:bg-white/15 transition-all duration-300">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {challenges.map((challenge, index) => <div key={index} className="bg-gradient-to-r from-red-900/30 to-purple-900/30 rounded-xl p-6 border border-white/20 backdrop-blur-sm">
        ...
        <div className="text-center">
          <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-lg px-8 py-3 font-semibold shadow-lg hover:shadow-xl transition-all duration-300" onClick={() => setIsModalOpen(true)}>
